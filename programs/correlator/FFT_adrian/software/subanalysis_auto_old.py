...
##########
# Analyzing path
pc_body = "E:/roof_MT1_2/20240308_cornerlab/"
filepath = "bulb_"
...
def readfile():
    ...
    resultfilename = "C:/Users/ii/Documents/curcor/corr_results/results_roof/" + datapath + "_" + this_pc1_filename.split("_")[-1].split(".")[0] + ".fcorr6"
