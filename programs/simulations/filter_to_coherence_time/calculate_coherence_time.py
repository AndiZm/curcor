...
add_spectrum(spectrum_x=np.loadtxt("Alluxa_465-2.txt")[:,0],spectrum_y=np.loadtxt("Alluxa_465-2.txt")[:,1], name="Alluxa 465-2", pcolor="blue", plinewidth=2)
...
plt.savefig("img/wavelengths.png")
...
plt.savefig("img/frequencies.png")
