...
ct3 = np.loadtxt("g2_functions/weight_rms_squared/{}/CT3.txt".format(star))
ct4 = np.loadtxt("g2_functions/weight_rms_squared/{}/CT4.txt".format(star))
...
np.savetxt("g2_functions/weight_rms_squared/{}/autocorrelation.txt".format(star), np.c_[x,g2_avg])
...
plt.title("{} auto correlation".format(star), fontsize=16)
plt.grid()
plt.xlim(-150,150)
plt.show()