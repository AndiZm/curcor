...
def chunk_ana(star, telcombi):
    ...
    np.savetxt("spatial_coherence/{}_{}_data.sc".format(star,telcombi), np.c_[baselines, dbaselines, ints_fixedA, dints_fixedA, ints_fixedB, dints_fixedB])
    np.savetxt("spatial_coherence/{}_{}_data_fixed.sc".format(star,telcombi), np.c_[baselines, dbaselines, ints_fixedA1, dints_fixedA1, ints_fixedB1, dints_fixedB1])
...
def plotting(star):
    ...
    for i in range(len(telcombis)):
        ...
        baselines     = np.loadtxt("spatial_coherence/{}_{}_data.sc".format(star,telcombis[i])) [:,0]
        dbaselines    = np.loadtxt("spatial_coherence/{}_{}_data.sc".format(star,telcombis[i])) [:,1]
        ints_fixedA   = np.loadtxt("spatial_coherence/{}_{}_data.sc".format(star,telcombis[i])) [:,2]
        dints_fixedA  = np.loadtxt("spatial_coherence/{}_{}_data.sc".format(star,telcombis[i])) [:,3]
        ints_fixedB   = np.loadtxt("spatial_coherence/{}_{}_data.sc".format(star,telcombis[i])) [:,4]
        dints_fixedB  = np.loadtxt("spatial_coherence/{}_{}_data.sc".format(star,telcombis[i])) [:,5]
        ints_fixedA1  = np.loadtxt("spatial_coherence/{}_{}_data_fixed.sc".format(star,telcombis[i])) [:,2]
        dints_fixedA1 = np.loadtxt("spatial_coherence/{}_{}_data_fixed.sc".format(star,telcombis[i])) [:,3]
        ints_fixedB1  = np.loadtxt("spatial_coherence/{}_{}_data_fixed.sc".format(star,telcombis[i])) [:,4]
        dints_fixedB1 = np.loadtxt("spatial_coherence/{}_{}_data_fixed.sc".format(star,telcombis[i])) [:,5]
        ...
        print("{}A 470nm Amplitude: {:.3f} +/- {:.3f}".format(telcombis[i], popt_odrA[0], perr_odrA[0]))
        print("{}B 375nm Angular diameter AVG (odr): {:.3f} +/- {:.3f} (mas)".format(telcombis[i], uti.rad2mas(popt_odrB[1]), uti.rad2mas(perr_odrB[1])))
        print("{}B 375nm Amplitude: {:.3f} +/- {:.3f}".format(telcombis[i], popt_odrB[0], perr_odrB[0]))
        ...
        np.savetxt("spatial_coherence/{}_{}_scaled.sc".format(star, telcombis[i]), np.c_[ints_fixedA_scaled, dints_fixedA_scaled, ints_fixedB_scaled, dints_fixedB_scaled], header="{} {} {} {}\nscA\tdscA\tscB\tdscB".format(popt_odrA[0], popt_odrB[0], popt_odrA[1],popt_odrB[1]))
        ...
        if telcombis[i] == 14:
            ...
            crfigureA.suptitle("Cross correlations of {} for {}".format(star, labelA),fontweight="bold")
            ...
            for n, A in enumerate(chAs):
                ...
                ax_crA.legend()
            plt.savefig('images/ana_final/g2_singles_{}.pdf'.format(labelA))
            ...
            for n, A in enumerate(chBs):    
                ...
                ax_crB.legend()
            plt.savefig('images/ana_final/g2_singles_{}.pdf'.format(labelB))
            ...
            ax_sc2.plot(xplot, uti.spatial_coherence(xplot,1, float(popt_odrA[1]), lam_g), label=labelA, color=colorA14, linewidth=2)
            ax_sc4.plot(xplot, uti.spatial_coherence(xplot,1, float(popt_odrB[1]), lam_uv), label=labelB, color=colorB14,  linewidth=2)
            ...
            ax_sc3.text(x=xplot_uv[800], y=10, s='Angular diameter: {:.3f} +/- {:.3f} (mas)'.format(uti.rad2mas(popt_odrB[1]), uti.rad2mas(perr_odrB[1])), color=colorB14, bbox=dict(boxstyle="round", ec="white", fc="white", alpha=0.75))
            ax_sc3.text(x=xplot_uv[800], y=9, s='Amplitude: {:.3f} +/- {:.3f}'.format(popt_odrB[0], perr_odrB[0]), color=colorB14, bbox=dict(boxstyle="round", ec="white", fc="white", alpha=0.75))
        ...
        # Subplot for all cross correlations for telcombi 34
            ...
            ax_sc2.plot(xplot, uti.spatial_coherence(xplot,1, float(popt_odrA[1]), lam_g), label=labelA, color=colorA34, linewidth=2)
            ax_sc4.plot(xplot, uti.spatial_coherence(xplot,1, float(popt_odrB[1]), lam_uv), label=labelB, color=colorB34,  linewidth=2)
            ...
            ax_sc3.text(x=xplot_uv[800], y=8, s='Angular diameter: {:.3f} +/- {:.3f} (mas)'.format(uti.rad2mas(popt_odrB[1]), uti.rad2mas(perr_odrB[1])), color=colorB34, bbox=dict(boxstyle="round", ec="white", fc="white", alpha=0.75))
            ax_sc3.text(x=xplot_uv[800], y=7, s='Amplitude: {:.3f} +/- {:.3f}'.format(popt_odrB[0], perr_odrB[0]), color=colorB34, bbox=dict(boxstyle="round", ec="white", fc="white", alpha=0.75))
