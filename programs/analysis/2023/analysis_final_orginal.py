...
np.savetxt("spatial_coherence/{}_scaled.sc".format(star), np.c_[baselines, dbaselines, ints_fixedA, dints_fixedA, ints_fixedB, dints_fixedB], header="{} {} {} {}\nbl\tdbl\tscA\tdscA\tscB\tdscB".format(popt_odrA[0], popt_odrB[0], popt_odrA[1],popt_odrB[1]))
