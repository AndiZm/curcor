    ...
    for i in range(len(telcombis)):
        ...
        if telcombis[i] == 14:
            ...
            for n, A in enumerate(chAs):
                ...
                ax_crA.legend()
            plt.savefig('images/ana_final/g2_singles_{}.pdf'.format(labelA[0:9]))
            ...
            for n, A in enumerate(chBs):    
                ...
                ax_crB.legend()
            plt.savefig('images/ana_final/g2_singles_{}.pdf'.format(labelB[0:9]))
        ...
        # Subplot for all cross correlations for telcombi 34
            ...
            for n, A in enumerate(chAs):
                ...
                ax_crA2.legend()
            plt.savefig('images/ana_final/g2_singles_{}.pdf'.format(labelA[0:0]))
