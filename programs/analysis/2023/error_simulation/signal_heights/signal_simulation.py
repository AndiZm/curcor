...
data = np.loadtxt("../g2_functions/weight_rms_squared/Mimosa/14/ChA_clean.txt")
...
plt.axhline(y = 1e6*integral_true, color="black", label="True coherence time")
