...
ct3 = np.loadtxt("g2_functions/weight_rms_squared/Nunki/CT3.txt")
ct4 = np.loadtxt("g2_functions/weight_rms_squared/Nunki/CT4.txt")
...
np.savetxt("g2_functions/weight_rms_squared/Nunki/autocorrelation.txt", np.c_[x,g2_avg])
...
plt.title("Nunki auto correlation", fontsize=16)
plt.grid()
plt.xlim(-150,150)
plt.show()