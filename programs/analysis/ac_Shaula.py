...
ct3 = np.loadtxt("g2_functions/weight_rms_squared/Shaula/CT3.txt")
ct4 = np.loadtxt("g2_functions/weight_rms_squared/Shaula/CT4.txt")
...
np.savetxt("g2_functions/weight_rms_squared/Shaula/autocorrelation.txt", np.c_[x,g2_avg])
