...
#### change  ###
rad = 4.5                   # radius of star in m
dis = 70  					# distance of star in m 
mag = 2.05 					# magnitude of star
#### #####
...
plot_values34 = np.arange(0, len(S_bl34), 20)
plot_values14 = np.arange(0, len(S_bl14), 20)

plt.plot(x,sc, zorder=0.5)


#plt.errorbar(bl12, S_bl12, yerr=deltaS12, marker='o', label='baseline 1-2')
for i in range(len(plot_values14)):
	plt.errorbar(bl14[plot_values14[i]], S_bl14[plot_values14[i]], yerr=deltaS14[plot_values14[i]], marker='o', zorder=5, color='green')
for i in range(len(plot_values34)):	
	plt.errorbar(bl34[plot_values34[i]], S_bl34[plot_values34[i]], yerr=deltaS34[plot_values34[i]], marker='o', zorder=1, color= 'orange')

plt.errorbar(bl14[plot_values14[0]], S_bl14[plot_values14[0]], yerr=deltaS14[plot_values14[0]], label='baseline 1-4', marker='o', zorder=5, color='green')
plt.errorbar(bl34[plot_values34[0]], S_bl34[plot_values34[0]], yerr=deltaS34[plot_values34[0]], label='baseline 3-4', marker='o', zorder=1, color= 'orange')
#plt.errorbar(bl14, S_bl14, yerr=deltaS14, marker='o', label='baseline 1-4', zorder=5)
#plt.errorbar(bl34[plot_values], S_bl34[plot_values], yerr=deltaS34[plot_values], marker='o', label='baseline 3-4', zorder=1)
