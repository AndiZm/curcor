...
ct3 = np.loadtxt("g2_functions/weight_rms_squared/Regor/CT3.txt")
ct4 = np.loadtxt("g2_functions/weight_rms_squared/Regor/CT4.txt")
...
np.savetxt("g2_functions/weight_rms_squared/Regor/autocorrelation.txt", np.c_[x,g2_avg])
...
plt.title("Regor auto correlation", fontsize=16)
plt.grid()
plt.xlim(-150,150)
plt.show()