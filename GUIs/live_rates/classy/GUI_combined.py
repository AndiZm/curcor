...
config_filename = filedialog.askopenfilename(initialdir = "../../", title = "Select telescope configuration file", filetypes = (("conf files","*.conf"),("all files","*.*")))
tel_data = np.loadtxt(config_filename, dtype={'names': ('tel_nos', 'tel_names', 'spcm_ports', 'datapaths', 'ports', 'modes'), 'formats': ('<f8', 'U15', '<f8', 'U15', '<f8', 'U15')}, ndmin=1)
