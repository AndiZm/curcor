...
MirrorHeightSetButton = Button(MirrorTHeadFrame, text="SET", width=3); MirrorHeightSetButton.grid(row=0,column=3)
...
MirrorZSetButton = Button(MirrorTLowerFrame, text="SET", width=3); MirrorZSetButton.grid(row=0,column=3)
...
MirrorPsiSetButton = Button(MirrorRHeadFrame, text="SET", width=3); MirrorPsiSetButton.grid(row=0,column=3)
...
MirrorPhiSetButton = Button(MirrorRLowerFrame, text="SET", width=3); MirrorPhiSetButton.grid(row=0,column=3)
...
CameraXSetButton = Button(CameraHeadFrame, text="SET", width=3); CameraXSetButton.grid(row=0,column=3)
...
CameraZSetButton = Button(CameraLowerFrame, text="SET", width=3); CameraZSetButton.grid(row=0,column=3)
