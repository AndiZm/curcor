...
MirrorTFrame.grid(row=0, column=0, padx=10, pady=3)

MirrorRFrame = Frame(mainFrame, width=200, height=400)
MirrorRFrame.grid(row=0, column=1, padx=10, pady=3)

CameraFrame = Frame(mainFrame, width=200, height=400)
CameraFrame.grid(row=0, column=2, padx=10, pady=3)
...
exit_button.grid(row=11, column=0, padx=10, pady=3)
