...
def set_max_current_mirror_height(val):
    ...
    print ("Set Mirror Height current limit to {}".format(a[2].get_axis_parameter(6)))
...
MirrorHeightSetButton = Button(MirrorTHeadFrame, text="Set", width=2); MirrorHeightSetButton.grid(row=0,column=3)
B1 = Button(MirrorTHeadFrame, text="Ref", bg="#D3D3D3", width=2, command=refsearch_mirror_height); B1.grid(row=0, column=4) 
...
MirrorHeightSpeed = Scale(MirrorTButtonFrame,from_=1, to=300, resolution=1, orient=HORIZONTAL, length=140, label="Speed"); MirrorHeightSpeed.grid(row=0, column=0, padx=10, pady=3)
...
MirrorZSpeed = Scale(MirrorTButtonFrame,from_=1, to=300, resolution=1, orient=HORIZONTAL, length=140, label="Speed"); MirrorZSpeed.grid(row=3, column=0, padx=10, pady=3)
...
MirrorZSetButton = Button(MirrorTLowerFrame, text="Set", width=2); MirrorZSetButton.grid(row=0,column=3)
B2 = Button(MirrorTLowerFrame, text="Ref", bg="#D3D3D3", width=2, command=refsearch_mirror_z); B2.grid(row=0, column=4)
...
MirrorZ = Scale(MirrorTBottomFrame, variable=mirror_z_pos, from_=0, to=120, resolution=0.1, orient=HORIZONTAL, length=250)
...
MirrorPsiSetButton = Button(MirrorRHeadFrame, text="Set", width=2); MirrorPsiSetButton.grid(row=0,column=3)
B4 = Button(MirrorRHeadFrame, text="Ref", bg="#D3D3D3", width=2, command=refsearch_mirror_psi); B4.grid(row=0, column=4) 
...
MirrorPhiSetButton = Button(MirrorRLowerFrame, text="Set", width=2); MirrorPhiSetButton.grid(row=0,column=3)
B5 = Button(MirrorRLowerFrame, text="Ref", bg="#D3D3D3", width=2, command=refsearch_mirror_phi); B5.grid(row=0, column=4)
...
CameraXSetButton = Button(CameraHeadFrame, text="Set", width=2); CameraXSetButton.grid(row=0,column=3)
B7 = Button(CameraHeadFrame, text="Ref", bg="#D3D3D3", width=2, command=refsearch_camera_x); B7.grid(row=0, column=4) 
...
CameraZSetButton = Button(CameraLowerFrame, text="Set", width=2); CameraZSetButton.grid(row=0,column=3)
B8 = Button(CameraLowerFrame, text="Ref", bg="#D3D3D3", width=2, command=refsearch_camera_z); B8.grid(row=0, column=4)
