...
class GUI:
    ...
    def __init__(self, master, controller, client=None):
        ...
        self.MirrorZSpeed = Scale(self.MirrorTButtonFrame,from_=0, to=5000, resolution=50, orient=HORIZONTAL, length=140, label="Speed");  self.MirrorZSpeed.set(controller.get_max_speed_mirror_z()); self.MirrorZSpeed.grid(row=4, column=0, padx=10, pady=3)
        ...
        self.MirrorZCurrent = Scale(self.MirrorTButtonFrame,from_=0.06, to=1.44, resolution=0.06, orient=HORIZONTAL, length=140, label="Max I"); self.MirrorZCurrent.set(controller.get_max_current_mirror_z()); self.MirrorZCurrent.grid(row=5, column=0, padx=10, pady=3)
        self.MirrorZAcc = Scale(self.MirrorTButtonFrame,from_=1, to=300, resolution=1, orient=HORIZONTAL, length=140, label="Acceleration");  self.MirrorZAcc.set(controller.get_max_acc_mirror_z()); self.MirrorZAcc.grid(row=6, column=0, padx=10, pady=3)
        self.MirrorZAcc.bind("<ButtonRelease-1>", self.new_acceleration_mirror_z); self.MirrorZAcc.set(controller.get_max_acc_mirror_z())
        self.MirrorZCurrent = Scale(self.MirrorTButtonFrame,from_=50, to=300, resolution=1, orient=HORIZONTAL, length=140, label="Max I"); self.MirrorZCurrent.grid(row=7, column=0, padx=10, pady=3)
        ...
        self.CameraXCurrent = Scale(self.CameraButtonFrame,from_=10, to=255, resolution=1, orient=HORIZONTAL, length=140, label="Max I"); self.CameraXCurrent.grid(row=2, column=0, padx=10, pady=3)
        ...
        self.CameraZSpeed = Scale(self.CameraButtonFrame,from_=0, to=5000, resolution=50, orient=HORIZONTAL, length=140, label="Speed"); self.CameraZSpeed.set(self.controller.get_max_speed_camera_z()); self.CameraZSpeed.grid(row=4, column=0, padx=10, pady=3)
        ...
        self.CameraZCurrent = Scale(self.CameraButtonFrame,from_=0.06, to=1.44, resolution=0.06, orient=HORIZONTAL, length=140, label="Max I");self.CameraZCurrent.set(self.controller.get_max_current_camera_z()); self.CameraZCurrent.grid(row=5, column=0, padx=10, pady=3)
        self.CameraZAcc = Scale(self.CameraButtonFrame,from_=1, to=2047, resolution=1, orient=HORIZONTAL, length=140, label="Acceleration"); self.CameraZAcc.set(controller.get_max_acc_camera_z()); self.CameraZAcc.grid(row=6, column=0, padx=10, pady=3)
        self.CameraZAcc.bind("<ButtonRelease-1>", self.new_acceleration_camera_z); self.CameraZAcc.set(controller.get_max_acc_camera_z())
        self.CameraZCurrent = Scale(self.CameraButtonFrame,from_=10, to=255, resolution=1, orient=HORIZONTAL, length=140, label="Max I"); self.CameraZCurrent.grid(row=7, column=0, padx=10, pady=3)
