...
class GUI:
    ...
    def __init__(self, master, controller, client=None):
        ...
        self.MirrorHeight= Scale(self.MirrorTUpperFrame,from_=40, to=0, resolution=0.1, orient=VERTICAL, length=350); self.MirrorHeight.set(self.controller.get_position_mirror_height()); self.MirrorHeight.grid(row=1, column=0, padx=10, pady=3)
        ...
        self.CameraX = Scale(self.CameraUpperFrame, from_=250, to=0, resolution=0.1, orient=VERTICAL, length=300); self.CameraX.set(self.controller.get_position_camera_x()); self.CameraX.grid(row=1, column=0, padx=10, pady=3)
